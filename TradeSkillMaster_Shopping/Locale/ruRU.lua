...
L["12 hours"] = "12 часов" -- Needs review
L["24 hours"] = "24 часа" -- Needs review
L["48 hours"] = "48 часов" -- Needs review
L["Accept"] = "Принять"
L["Add Item"] = "Добавить предмет"
L["Add Item / Search Term"] = "Добавить предмет / поисковое выражение" -- Needs review
L["Add item to dealfinding list"] = "Добавить предмет в список dealfinding" -- Needs review
L["Add Item to Dealfinding List"] = "Добавить предмет в список Dealfinding" -- Needs review
L["Add Item to New List"] = "Добавить предмет в новый список" -- Needs review
L["Add Item to Selected List"] = "Добавить предмет в выбранный список" -- Needs review
L["Add item to shopping list"] = "Добавить предмет в список покупок" -- Needs review
L["Add Item to Shopping List"] = "Добавить предмет в список покупок" -- Needs review
L["Additional Options:"] = "Дополнительные опции:" -- Needs review
L["Add Search Term"] = "Добавить поисковое выражение" -- Needs review
L["Are you sure you want to delete the selected profile?"] = "Вы действительно хотите удалить выбранный профиль?"
L["Auction Buyout:"] = "Цена выкупа:" -- Needs review
L["Auction Buyout (Stack Price):"] = "Цена выкупа (цена стопки):" -- Needs review
L["Auction Duration"] = "Срок аукциона" -- Needs review
L["Auction Item Price"] = "Цена за предмет" -- Needs review
-- L["Auction not found. Restarting search."] = ""
-- L["Auctions"] = ""
L["Auction Stack Price"] = "Цена за стопку" -- Needs review
-- L["Automatically Expand Single Result"] = ""
-- L["Below are some general options for the Shopping module."] = ""
L["Bid Percent"] = "Процент ставки" -- Needs review
L["Cancel"] = "Отмена"
-- L["Canceling"] = ""
...
L["Crafting Cost:"] = "Цена крафта:" -- Needs review
-- L["Crafting Mats"] = ""
L["Create a new empty profile."] = "Создать новый пустой профиль."
L["Current Profile:"] = "Текущий профиль:"
-- L["Data Imported to Group: %s"] = ""
L["Dealfinding list deleted: \"%s\""] = "Удалён список Dealfinding: \"%s\"" -- Needs review
L["Dealfinding List Name"] = "Имя списка Dealfinding" -- Needs review
L["Dealfinding Lists"] = "Списки Dealfinding" -- Needs review
L["Dealfinding Search"] = "Поиск Dealfinding" -- Needs review
L["Default"] = "По умолчанию" -- Needs review
L["Default Undercut"] = "По умолчанию подрезать на" -- Needs review
L["Delete a Profile"] = "Удалить профиль"
L["Delete existing and unused profiles from the database to save space, and cleanup the SavedVariables file."] = "Удалить существующие и неиспользуемые профили и очистить файл SavedVariables." -- Needs review
L["Delete / Export List"] = "Удаление / Экспорт списка" -- Needs review
L["Delete List"] = "Удалить список" -- Needs review
L["Destroying Modes to Use:"] = "Используемые режимы уничтожения:" -- Needs review
...
L["% Expected Cost"] = "% ожидаемой цены" -- Needs review
-- L["Export List"] = ""
...
-- L["Invalid Min Level"] = ""
L["Invalid money format entered, should be \"#g#s#c\", \"25g4s50c\" is 25 gold, 4 silver, 50 copper."] = "Введён неверный денежный формат, должен быть \"#g#s#c\", \"25g4s50c\" - это 25 золотых, 4 серебряных, 50 медных." -- Needs review
...
-- L["Items"] = ""
-- L["Item Settings"] = ""
L["Item to Add"] = "Добавить предмет" -- Needs review
...
L["% Market Value"] = "% рыночной цены" -- Needs review
-- L["MAX"] = ""
L["% Max Price"] = "% макс. цены" -- Needs review
...
L["%s is already in a dealfinding list and has been removed from this list."] = "%s уже находится в списке dealfinding и был удалён из текущего списка." -- Needs review
L["%s item(s) will be removed (already in a dealfinding list)"] = "%s предмет(а/ов) будет удалён (уже в списке dealfinding)" -- Needs review
