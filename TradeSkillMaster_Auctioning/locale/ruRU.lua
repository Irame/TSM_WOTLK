...
L["How many auctions at the lowest price tier can be up at any one time. Setting this to 0 disables posting for any groups this operation is applied to."] = "Как много товаров с низкой ценой могут подорожать в будущем. Значение 0 отключает эту операцию для всех групп." -- Needs review
