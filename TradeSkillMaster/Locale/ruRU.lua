...
L["Any guilds which are selected will be ignored for inventory tracking purposes."] = "Любые выбранные гильдии будут игнорироваться при отслеживании инвентаря."
...
L["Destroy Values"] = "Стоимость уничтожения"
...
L["Display mill value in tooltip."] = "Отображать стоимость измельчения в подсказке."
L["Display Operation Names in Tooltip for Modules:"] = "Отображать имена операций в подсказке для модулей:"
L["Display prospect value in tooltip."] = "Отображать стоимость просеивания в подсказке."
...
L["Enhances the vendor frame by allowing you to easily buy and sell items."] = "Улучшает окно продавца, позволяя вам с легкостью покупать и продавать предметы."
...
L["Import Operation Settings"] = "Настройки импорта"
...
L["Looks like TradeSkillMaster has detected an error with your configuration. Please address this in order to ensure TSM remains functional."] = "Похоже, что TradeSkillMaster обнаружил ошибку в вашей конфигурации. Пожалуйста, устраните её для того, чтобы TSM сохранял свою функциональность."
