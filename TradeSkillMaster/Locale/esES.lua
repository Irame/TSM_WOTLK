...
L["Account Syncing"] = "Sincronización de cuentas."
L["Active Contributors:"] = "Contribuidores activos:"
L["Acts as a link between the other TradeSkillMaster modules and the TSM Desktop Application."] = "Actúa como un enlace entre los otros módulos TradeSkillMaster y la aplicación de escritorio de TSM."
...
L["AH"] = "AH"
L["Alarm Clock"] = "Alarma de reloj."
L["All items in this group and its subgroups will be moved to the parent group and this group and all of its subgroups will be deleted."] = "Todos los elementos de este grupo y sus subgrupos se moverán al grupo principal y este grupo y todos sus subgrupos serán borrados."
L["All items in this group and its subgroups will be removed and this group and all of its subgroups will be deleted."] = "Todos los elementos de este grupo y sus subgrupos serán eliminados y se eliminarán este grupo y todos sus subgrupos."
...
L["Any guilds which are selected will be ignored for inventory tracking purposes."] = "Cualquier hermandad que sea seleccionada será ignorada con fines de seguimiento de inventario."
...
L["Are you sure you want to delete this group?"] = "¿Estás seguro de querer borrar este grupo?"
L["Are you sure you want to delete this operation?"] = "¿Estás seguro de querer borrar esta operación?"
L["Are you sure you want to overwrite the current profile with the selected profile?"] = "¿Está seguro de que quieres sobrescribir el perfil actual con el perfil seleccionado?"
L["A simple, fixed gold amount."] = "Un simple, fijo oro acumulado."
L["Auctionator - Auction Value"] = "Auctionator - Valor de la subasta"
L["Auction Buys"] = "Subastas compradas."
...
L["Auction Rows (Requires Reload)"] = "Filas de subastas (Requiere reloguear)"
L["Auctions"] = "Subastas"
L["Auction Sales"] = "Subastas vendidas."
L["Auction Window Close"] = "Ventana de subasta cerrada."
L["Auction Window Open"] = "Ventana de subasta abierta."
L["Auto Quest Complete"] = "Auto búsqueda completada."
L["Bags"] = "Bolsas."
L["Bank"] = "Banco."
L["BankUI"] = "Interfaz de Banco"
-- L["BankUI Move Delay"] = ""
L["BankUI Settings"] = "Opciones de BankUI"
...
L["Cancelled - Bags and Bank / Guild Vault are full"] = "Cancelado- Bolsas, banco y cámara de hermandad están completos."
L["Cancelled - Bags are full"] = "Cancelado - Bolsas están llenas"
L["Cancelled - Bank / Guild Vault is full"] = "Cancelado- Banco y cámara de hermandad están completos."
L["Cancelled - You must be at a bank or GuildVault"] = "Cancelado - Debe estar en una cámara de hermandad."
...
L["Click to change what is shown in this column."] = "Haga clic para cambiar lo que se muestra en esta columna."
...
L["Include Operations"] = "Incluir Operaciones"
...
L["Known Characters: "] = "Personajes conocidos:"
...
L["Looks like TradeSkillMaster has encountered an error. Please help the author fix this error by copying the entire error below and following the instructions for reporting lua errors listed at the following URL:"] = "Parece que TradeSkillMaster ha encontrado un error. Por favor, ayuda al autor a corregir este error copiando el mensaje de error de abajo y siguiendo las instrucciones para reportar errores de lua listadas en la siguiente URL:"
...
L["Options"] = "Opciones"
L["Options / Core Features"] = "Opciones / Características básicas."
...
L["Play the selected sound when one of your auctions sells."] = "Reproduce el sonido seleccionado cuando es vendida una de tus subastas."
...
L["Rename Custom Price Source"] = "Renombrar fuente de precio personalizado."
L["Rename Group"] = "Renombrar Grupo"
L["Rename Operation"] = "Renombrar Operacion"
L["Replace"] = "Reemplazar"
L["Reset Profile"] = "Resetear Perfil"
L["Resets the position, scale, and size of all applicable TSM and module frames."] = "Restablece la posición, la escala y el tamaño de todos los marcos de TSM y módulos aplicables."
...
L["See the following URL for more info."] = "Visita la siguiente URL para más información."
...
L["Select the default tab for this module's operations."] = "Seleccione la pestaña por defecto para las operaciones de este módulo."
...
L["Send to Other Account"] = "Enviar a otra cuenta."
...
-- L["Show on Modifier:"] = ""
L["Simple"] = "Sencillo."
L["%s in guild vault"] = "%s en la cámara de la hermandad."
...
L["%s (%s bags, %s bank, %s AH, %s mail)"] = "%s (%s bolsas, %s banco, %s AH, %s correo)"
L["%s (%s player, %s alts, %s guild, %s AH)"] = "%s (%s jugador, %s alter, %s hermandad, %s AH)"
...
L["This option sets which tab TSM and its modules will use for printing chat messages."] = "Este conjunto de opciones de la pestaña del TSM y sus módulos se utilizaran para mostrar los mensajes de chat."
...
L["TSM Features"] = "Características de TSM"
...
If you have this checked when adding an ungrouped randomly enchanted item, it will act as all possible random enchants of that item.]=] ] = "Cuando se activa, los encantamientos aleatorios serán ignorados por artículos sin grupo."
